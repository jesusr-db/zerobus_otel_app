...
export function DashboardView() {
  ...
  const getHealthColor = (status: string) => {
    switch (status) {
      ...
      case "warning":
        return "bg-[hsl(30,80%,55%)] text-primary-foreground";
      case "healthy":
        return "bg-[hsl(160,60%,45%)] text-primary-foreground";
      default:
            ...
            >
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`rounded-full px-2 py-1 text-xs font-medium ${getHealthColor(service.health_status)}`}
                  >
